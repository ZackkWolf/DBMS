...
<div class="container registration-container">
        ...
        <form  action ="login_stud_chk.php" method="post">
            ...
            <div class="form-group1" style="padding-top:15px">
                <label for="ctc">Avg. CTC</label>
        
                <input type="ctc" id="ctc" name="ctc" class="form-control" placeholder="CTC">
            </div>  
            <div class="form-group1" style="padding-top:15px">
                <label for="job">Job</label>
                <input type="job" id="job" name="job" class="form-control" placeholder="Job">
            </div>
            <div class="form-group1" style="padding-top:15px">
            ...
            <div class="form-group1" style="padding-top:15px">
                ...
                <input type="fields" id="fields" name="fields" class="form-control" placeholder="fields">
            </div>
