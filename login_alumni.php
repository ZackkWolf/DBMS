...
<div class="container registration-container">
        ...
        <form  action ="login_alumni_chk.php" method="post">
    ...
    ?>
            ...
            <button type="submit" class="btn btn-primary btn-block" onClick="window.location.href='http://127.0.0.1:5500/index_after_login.php';"
                style="background-color: #343a40; font-size:large ; border-color: #88E05E">Login</button>
        </form>
        <p class="text-center mt-3">Don't have an account? <a href="register_alumni.php">Register</a></p>
    </div>
