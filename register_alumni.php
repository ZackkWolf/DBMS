  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="login_alumni.php">Login</a>
        </li>
    ...
    <div class="container registration-container">
        <h1>Register as Alumni</h1><br><br><br>
        <form action="reg_stud.php" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" id="username" name="RollNo" class="form-control" placeholder="Roll No">
            </div>
            <div class="form-group">
                <label for="Email">Web-Email</label>
                <input type="email" id="email" name="Email" class="form-control" placeholder="abc@iitp.ac.in">
            </div>
            <div class="form-group">
        ...
        <p class="text-center mt-3">Already have an account? <a href="login_alumni.php">Login</a></p>
    </div>
